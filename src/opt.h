...
public:
    ...
    void end_of_options() const throw()
    {
    ...
    OPT_INLINE opt& operator >> (const _Option& opt) throw();
    ...
    template <class T> inline T getopt(char short_opt, const std::string& long_opt) throw()
    {
        T result;
    ...
    template <class T> inline T getopt(char short_opt) throw()
    {
        T result;
